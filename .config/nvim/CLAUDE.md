...
2. luasnip (snippets)
3. buffer (text in current buffer)
4. path (file paths)

GitHub Copilot is configured separately in copilot.lua as inline ghost-text suggestions (accept with "<Tab>"), not as a cmp source.
